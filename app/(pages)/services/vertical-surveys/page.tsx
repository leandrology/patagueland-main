    ...
    <>
      <section className="bg-primary-50 dark:bg-slate-800">
        <div className="mx-auto max-w-7xl px-4 pb-16 pt-1 text-center sm:px-6 md:pb-20 lg:px-8">
          <h1 className="py-4 text-4xl md:text-5xl">Vertical Surveys</h1>
            ...
            <div className="self-center md:basis-1/2">
              <div className="ml-4">
                ...
                <p className="mb-5 mt-2 text-lg text-gray-600 dark:text-slate-400">
                  A vertical survey is a type of land survey that is used to measure the elevation of points on the
                  ground relative to a known datum, such as sea level or a local benchmark. It is typically conducted by
                  a licensed land surveyor and can be used for a variety of purposes
                </p>
              </div>
